...
public class ActoresServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String[] arrayCategorias = request.getParameterValues("categoria");
        List<Actor> listaActores = this.actorFacade.findFilmByCategorias(arrayCategorias);
        request.setAttribute("listaActores", listaActores);
        
        
        RequestDispatcher rd = this.getServletContext().getRequestDispatcher("/actores.jsp");
